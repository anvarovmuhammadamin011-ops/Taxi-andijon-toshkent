export default function Splash() {
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-bg safe-top safe-bottom">
      <div className="flex h-24 w-24 items-center justify-center rounded-[28px] tile-gradient shadow-soft animate-scale-in">
        <span className="text-5xl" style={{ transform: "rotate(-12deg)" }}>
          🚕
        </span>
      </div>
